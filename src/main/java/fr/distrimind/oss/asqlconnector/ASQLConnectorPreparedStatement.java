...
public class ASQLConnectorPreparedStatement implements PreparedStatement {
  ...
  public ASQLConnectorPreparedStatement(String sql, ASQLConnectorConnection asqlconnector, int autoGeneratedKeys) {
    ...
    Log.v("new ASQLConnector prepared statement from " + asqlconnector);
  ...
  public void setSQL(String sql) {
    ...
    isSelect = sql.toUpperCase().matches("(?m)(?s)\\s*SELECT.*");
	  ...
	  potentialResultSet = isSelect || (!sql.toUpperCase().matches("(?m)(?s)\\s*CREATE.*") && !sql.toUpperCase().matches("(?m)(?s)\\s*DROP.*"));
  }
  ...
  public int executeUpdate() throws SQLException {
    ...
    if (autoGeneratedKeys == PreparedStatement.RETURN_GENERATED_KEYS) {
        ...
        return 1;  // This should be more efficient than ASQLConnectorConnection.changedRowsCount()
    }
    return updateCount;
  }
  ...
  public int executeUpdate(String thisSql, int autoGeneratedKeys) throws SQLException {
	  ...
	  return ASQLConnectorConnection.changedRowsCount();
  }
